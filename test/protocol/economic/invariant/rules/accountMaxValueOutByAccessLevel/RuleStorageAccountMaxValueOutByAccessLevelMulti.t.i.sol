...
contract RuleStorageAccountMaxValueOutByAccessLevelMultiTest is RuleStorageInvariantCommon {
    ...
    function invariant_rulesTotalAccountMaxValueOutByAccessLevelNeverDecreases() public view {
        uint256 total;
    ...
    function invariant_rulesTotalAccountMaxValueOutByAccessLevelEqualsAppBalances() public view {
        uint256 total;
        for (uint i; i < actors.length; i++) {
            total += actors[i].totalRules();
        }
    ...
    function invariant_rulesTotalAccountMaxValueOutByAccessLevelLessThanMax() public view {
