...
contract RuleStorageAccountMaxTradeSizeMultiTest is RuleStorageInvariantCommon {
    ...
    function setUp() public {
        ...
        switchToRuleAdmin();
        index = TaggedRuleDataFacet(address(ruleProcessor)).addAccountMaxTradeSize(address(applicationAppManager), createBytes32Array(bytes32("tag")), createUint192Array(223456789), createUint16Array(24), uint64(block.timestamp));
    ...
    function invariant_rulesTotalAccountMaxTradeSizeIncrementsByOne() public {
        ...
        assertEq(previousTotal, TaggedRuleDataFacet(address(ruleProcessor)).addAccountMaxTradeSize(address(applicationAppManager), createBytes32Array(bytes32("tag")), createUint192Array(223456789), createUint16Array(24), uint64(block.timestamp)));
    }
