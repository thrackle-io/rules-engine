 ...
 */
contract RuleStorageAccountMaxValueByAccessLevelMultiTest is
    RuleStorageInvariantCommon
{
    ...
    function setUp() public {
        ...
        for (uint i; i < 10; i++) {
            ...
            actors.push(
                new RuleStorageAccountMaxValueByAccessLevelActor(
                    ruleProcessor,
                    actorAppManager
                )
            );
        ...
        actorManager = new RuleStorageAccountMaxValueByAccessLevelActorManager(
            actors
        );
        switchToRuleAdmin();
    ...
    function invariant_rulesTotalAccountMaxValueByAccessLevelEqualsAppBalances()
        public
        view
    {
        uint256 total;
    ...
    function invariant_rulesTotalAccountMaxValueByAccessLevelLessThanMax()
        public
        view
    {
        assertLe(
    ...
    function invariant_rulesTotalAccountMaxValueByAccessLevelIncrementsByOne()
        public
    {
    ...
    function invariant_AccountMaxValueByAccessLevelImmutable() public view {
        assertEq(
            ruleBefore[0],
            ApplicationAccessLevelProcessorFacet(address(ruleProcessor))
                .getAccountMaxValueByAccessLevel(index, 0)
