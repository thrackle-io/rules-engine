...
contract RuleStorageAccountMaxValueByAccessLevelMultiTest is RuleStorageInvariantCommon {
    ...
    function invariant_rulesTotalAccountMaxValueByAccessLevelNeverDecreases() public view {
        uint256 total;
    ...
    function invariant_rulesTotalAccountMaxValueByAccessLevelEqualsAppBalances() public view {
        uint256 total;
        for (uint i; i < actors.length; i++) {
            total += actors[i].totalRules();
        }
    ...
    function invariant_rulesTotalAccountMaxValueByAccessLevelLessThanMax() public view {
