...
contract RuleStorageAccountMinMaxTokenBalanceMultiTest is RuleStorageInvariantCommon {
    ...
    function setUp() public {
        ...
        switchToRuleAdmin();
        index = TaggedRuleDataFacet(address(ruleProcessor)).addAccountMinMaxTokenBalance(
    ...
    function invariant_rulesTotalAccountMinMaxTokenBalanceNeverDecreases() public view {
        uint256 total;
    ...
    function invariant_rulesTotalAccountMinMaxTokenBalanceEqualsAppBalances() public view {
        uint256 total;
        for (uint i; i < actors.length; i++) {
            total += actors[i].totalRules();
        }
    ...
    function invariant_rulesTotalAccountMinMaxTokenBalanceLessThanMax() public view {
