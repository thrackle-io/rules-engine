...
contract RuleStorageTokenMaxSupplyVolatilityMultiTest is RuleStorageInvariantCommon {
    ...
    function invariant_rulesTotalTokenMaxSupplyVolatilityNeverDecreases() public view {
        uint256 total;
    ...
    function invariant_rulesTotalTokenMaxSupplyVolatilityEqualsAppBalances() public view {
        uint256 total;
        for (uint i; i < actors.length; i++) {
            total += actors[i].totalRules();
        }
    ...
    function invariant_rulesTotalTokenMaxSupplyVolatilityLessThanMax() public view {
