...
contract RuleStorageTokenMaxTradingVolumeMultiTest is RuleStorageInvariantCommon {
    ...
    function invariant_rulesTotalTokenMaxTradingVolumeNeverDecreases() public {
        uint256 total;
    ...
    function invariant_rulesTotalTokenMaxTradingVolumeEqualsAppBalances() public {
        uint256 total;
        for(uint i; i < actors.length; i++){
            total += actors[i].totalRules();
        }
        console.log(total);
        console.log(ERC20RuleProcessorFacet(address(ruleProcessor)).getTotalTokenMaxTradingVolume());
    ...
    function invariant_rulesTotalTokenMaxTradingVolumeLessThanMax() public {
    ...
    function invariant_TokenMaxTradingVolumeImmutable() public {
