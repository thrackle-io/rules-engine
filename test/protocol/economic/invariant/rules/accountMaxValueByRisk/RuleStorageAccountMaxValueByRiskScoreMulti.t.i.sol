...
contract RuleStorageAccountMaxValueByRiskScoreMultiTest is RuleStorageInvariantCommon {
    ...
    function invariant_rulesTotalAccountMaxValueByRiskScoreNeverDecreases() public {
        uint256 total;
    ...
    function invariant_rulesTotalAccountMaxValueByRiskScoreEqualsAppBalances() public {
        uint256 total;
        for(uint i; i < actors.length; i++){
            total += actors[i].totalRules();
        }
        console.log(total);
        console.log(ApplicationRiskProcessorFacet(address(ruleProcessor)).getTotalAccountMaxValueByRiskScore());
    ...
    function invariant_rulesTotalAccountMaxValueByRiskScoreLessThanMax() public {
    ...
    function invariant_AccountMaxValueByRiskScoreImmutable() public {
