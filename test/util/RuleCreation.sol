...
abstract contract RuleCreation is TestCommonFoundry {
    ...
    */
    ...
    function createAccountMaxValueOutByAccessLevelRule(uint48 withdrawalLimits1, uint48 withdrawalLimits2, uint48 withdrawalLimits3, uint48 withdrawalLimits4, uint48 withdrawalLimits5) public returns(uint32) {
        switchToRuleAdmin();
