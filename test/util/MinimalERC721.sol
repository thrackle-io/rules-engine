...
import "src/client/token/ERC721/IProtocolERC721Min.sol";
 ...
 */
contract MinimalERC721 is ERC721, IProtocolERC721Min, ProtocolTokenCommon, ERC721Burnable, ERC721Enumerable, AppAdministratorOrOwnerOnly {
     ...
     */
    function connectHandlerToToken(address _handlerAddress) external override(IProtocolERC721Min, ProtocolTokenCommon) appAdministratorOnly(appManagerAddress) {
