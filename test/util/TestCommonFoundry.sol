...
abstract contract TestCommonFoundry is TestCommon, EndWithStopPrank, EnabledActionPerRuleArray, AccessControl {
    ...
    function setUpProcotolAndCreateERC20AndHandlerSpecialOwner() public endWithStopPrank {
        ...
        HandlerVersionFacet(address(applicationCoinHandlerSpecialOwner)).updateVersion("1.3.1");
        /// register the token
    ...
    function setUpProcotolAndCreateERC20AndDiamondHandler() public endWithStopPrank {
        ...
        /// create an ERC721
        (applicationNFT, applicationNFTHandler) = deployAndSetupERC721("WolfMan", "WolfManPIC");
        (applicationNFTv2, applicationNFTHandlerv2) = deployAndSetupERC721("ToughTurtles", "THTR");
