 ...
 */
contract RuleProcessingAccountMaxTradeSizeActor is TestCommonFoundry, RuleProcessingInvariantActorCommon {
     ...
     * @dev test the rule
     */
    function checkAccountMaxTradeSize(uint256 _amount, address amm, address _token) public {
