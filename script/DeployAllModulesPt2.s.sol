...
contract DeployAllModulesPt2Script is Script, DiamondScriptUtil {
    ...
    function deployFacets() internal {
        ...
        string[5] memory directories = [
            "./out/ApplicationRiskProcessorFacet.sol/",
            "./out/ApplicationAccessLevelProcessorFacet.sol/",
            "./out/ApplicationPauseProcessorFacet.sol/",
            "./out/ERC20TaggedRuleProcessorFacet.sol/",
            "./out/ERC721TaggedRuleProcessorFacet.sol/"
        ];
