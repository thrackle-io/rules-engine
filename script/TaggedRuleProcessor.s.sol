...
import {TaggedRuleProcessorDiamond, TaggedRuleProcessorDiamondArgs as DiamondArgs} from "../src/economic/ruleProcessor/tagged/TaggedRuleProcessorDiamond.sol";

/**
 * @title Tagged Rule Processor Diamond Deploy Script
 * @author @ShaneDuncan602, @oscarsernarosero, @TJ-Everett
 * @dev This contract deploys the Tagged Rule Processor Diamond
 */

contract TaggedRuleProcessorDiamondScript is Test {
    ...
    function run() external {
        ...
        /// Deploy the diamond.
        taggedRuleProcessorDiamond = new TaggedRuleProcessorDiamond(_facetCuts, diamondArgs);
        vm.stopBroadcast();
    }
}
