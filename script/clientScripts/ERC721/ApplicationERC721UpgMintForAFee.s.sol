...
contract ApplicationERC721UScript is Script, DeployBase {
    ...
    function run() public {
        ...
        ApplicationERC721UpgMintForAFee applicationNFT = new ApplicationERC721UpgMintForAFee();
        ...
        ApplicationERC721UpgMintForAFee(payable(address(applicationNFTProxy))).initialize("Frankenstein", "FRANK", vm.envAddress("APPLICATION_APP_MANAGER"), "dummy.uri.io", 1);
        ...
        ApplicationERC721UpgMintForAFee(payable(address(applicationNFTProxy))).connectHandlerToToken(address(applicationNFTHandlerDiamond));
