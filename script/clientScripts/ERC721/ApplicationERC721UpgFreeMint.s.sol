...
contract ApplicationERC721UScript is Script, DeployBase {
    ...
    function run() public {
        ...
        ApplicationERC721UpgFreeMint applicationNFT = new ApplicationERC721UpgFreeMint();
        ...
        ApplicationERC721UpgFreeMint(address(applicationNFTProxy)).initialize("Frankenstein", "FRANK", vm.envAddress("APPLICATION_APP_MANAGER"), "dummy.uri.io");
        ...
        ApplicationERC721UpgFreeMint(address(applicationNFTProxy)).connectHandlerToToken(address(applicationNFTHandlerDiamond));
