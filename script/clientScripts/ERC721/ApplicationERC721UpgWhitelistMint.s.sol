...
contract ApplicationERC721UScript is Script, DeployBase {
    ...
    function run() public {
        ...
        ApplicationERC721UpgWhitelistMint applicationNFT = new ApplicationERC721UpgWhitelistMint();
        ...
        ApplicationERC721UpgWhitelistMint(payable(address(applicationNFTProxy))).initialize("Frankenstein", "FRANK", vm.envAddress("APPLICATION_APP_MANAGER"), "dummy.uri.io", 1);
        ...
        ApplicationERC721UpgWhitelistMint(payable(address(applicationNFTProxy))).connectHandlerToToken(address(applicationNFTHandlerDiamond));
