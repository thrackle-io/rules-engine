...
This guide is intended to be a user-friendly introduction to the Forte rules engine. It will provide a walkthrough of how to get started with the protocol, as well as provide a reference for the available rules and how to create custom rules.
...
|[Integration of Oracles][oracles-url]| This section contains documentation on how oracles integrate into the Forte rules engine and the process of integrating them.|
