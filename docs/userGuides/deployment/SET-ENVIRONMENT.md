...
3. Set the Application Admin Address
   ...
   2. Export it to zsh
        ````
        export APP_ADMIN_01=0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266(substitute with your desired address)
        ````
4. Set the Application Admin Private Key
   ...
   2. Export it to zsh
        ````
        export APP_ADMIN_PRIVATE_KEY_01=0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80(substitute with your desired private key)
        ````
