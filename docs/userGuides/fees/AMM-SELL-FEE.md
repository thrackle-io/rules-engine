...
Sell fees are assessed on the collateralized token being received during swaps for application tokens inside the AMM. The fees are additive. If a user has multiple applicable fees, the sum of all their fees will be assessed. 
