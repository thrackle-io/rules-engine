...
Library for Tagged Rules

*Library stores facets and selectors for Tagged Rules Module*
...
|----|----|-----------|
|`ds`|`TaggedRuleProcessorsStorage`|Data storage for Tagged Rule Processor Storage|
