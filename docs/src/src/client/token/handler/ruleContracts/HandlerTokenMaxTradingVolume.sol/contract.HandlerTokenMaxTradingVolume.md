...
[Git Source](https://github.com/thrackle-io/tron/blob/f405cfa7d52aca0d1bdf3d82da9748579a0bb635/src/client/token/handler/ruleContracts/HandlerTokenMaxTradingVolume.sol)
...
*Set the setTokenMaxTradingVolumeRule suite. Restricted to rule administrators only.*
