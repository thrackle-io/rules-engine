# ApplicationDeployAppManagerForUpgradeScript
[Git Source](https://github.com/thrackle-io/tron/blob/81964a0e15d7593cfe172486fd6691a89432c332/src/example/script/Application_Deploy_08_UpgradeTesting.s.sol)

**Inherits:**
Script

Deploys a new application App Manager and ERC20 handler. This is for upgrade testing only.
...
*This script will deploy the App Manager and an ERC20 token Handler.*
