 ...
 * @notice This contract automatically mints reward tokens for users upon claim. Reward is calculated in stake function.
 */
contract ERC20AutoMintStaking is IERC20Staking, Context, AppAdministratorOnly {
    ...
    constructor(address _rewardTokenAddress, address _stakingTokenAddress, address _appManagerAddress) {
        ...
        emit ERC20StakingFixedDeployed(_appManagerAddress, true, _rewardTokenAddress, _stakingTokenAddress);
    }
