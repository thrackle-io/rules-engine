 ...
 * @dev This is an example of a staking contract for ERC721 tokens with ERC20 reward token
 ...
 */
contract ERC721Staking is IERC721Staking, IERC721Receiver, Context, AppAdministratorOnly {
    /// Reward token
    ...
    // uint128[7] public rewardsPerTimeUnitPerTokenStaked;
    ...
    constructor(address _rewardTokenAddress, address[] memory _stakingTokenAddresses, uint128[7][] memory _rewardsPerAddress, address _appManagerAddress) {
        ...
        emit ERC721StakingFixedDeployed(_appManagerAddress, false, _rewardTokenAddress, _stakingTokenAddresses);
    }
