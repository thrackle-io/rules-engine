...
import "../../ERC721/upgradeable/ApplicationERC721UpgMintForAFee.sol";
...
contract ApplicationERC721UScript is Script {
    ...
    function run() public {
        ...
        ApplicationERC721Upgradeable(payable(address(applicationNFTProxy))).initialize("Frankenstein", "FRANK", vm.envAddress("APPLICATION_APP_MANAGER"), "dummy.uri.io", 10_000_000 gwei);
        ...
        ApplicationERC721Upgradeable(payable(address(applicationNFTProxy))).connectHandlerToToken(address(applicationNFTHandler));
