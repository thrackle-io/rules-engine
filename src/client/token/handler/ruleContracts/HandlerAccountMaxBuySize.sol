...
contract HandlerAccountMaxBuySize is ActionTypesArray, RuleAdministratorOnly, ITokenHandlerEvents, IAssetHandlerErrors {
    ...
    function setAccountMaxBuySizeIdUpdate(ActionTypes _action, uint32 _ruleId) internal {
        ...
        IRuleProcessor(lib.handlerBaseStorage().ruleProcessor).validateAccountMaxBuySize(createActionTypesArray(_action), _ruleId);
