...
contract HandlerTokenMaxSellVolume is ActionTypesArray, RuleAdministratorOnly, ITokenHandlerEvents, IAssetHandlerErrors {
    ...
    function setTokenMaxSellVolumeIdUpdate(ActionTypes _action, uint32 _ruleId) internal {
        ...
        IRuleProcessor(lib.handlerBaseStorage().ruleProcessor).validateTokenMaxSellVolume(createActionTypesArray(_action), _ruleId);
