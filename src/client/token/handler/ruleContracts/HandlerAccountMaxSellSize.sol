...
contract HandlerAccountMaxSellSize is ActionTypesArray, RuleAdministratorOnly, ITokenHandlerEvents, IAssetHandlerErrors {
    ...
    function setAccountMaxSellSizeIdUpdate(ActionTypes _action, uint32 _ruleId) internal {
        ...
        IRuleProcessor(lib.handlerBaseStorage().ruleProcessor).validateAccountMaxSellSize(createActionTypesArray(_action), _ruleId);
