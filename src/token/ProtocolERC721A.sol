...
/**
 * @title ERC721A Base Contract for Protocol
 ...
 * @notice This contract is the base ERC721A used for new ERC721A contracts.
 */
contract ProtocolERC721A is IERC721A, Pausable, AppAdministratorOnly, IApplicationEvents, IZeroAddressError {
     ...
     * @return 0 to start tokenId counter at 0
     */
     ...
     * @return _currentIndex counter of all created tokens
     */
     ...
     * @notice Minted total may be higher than total supply if tokens have been burned
     * @return Minted Total
     */
     ...
     * @return Number of tokens held by address
     */
     ...
     * @param owner Address of Owner
     * @return Number of tokens minted by address
     */
    ...
    /**
     * @dev Internal Function to return number of tokens burned by address
     * @param owner Address of Owner
     * @return the number of tokens burned by or on behalf of `owner`.
     */
    ...
    /**
     * @dev Internal Function to return owner of whitelisted slots for minting
     * @param owner Address of Owner
     * @return the auxiliary data for `owner`. (e.g. number of whitelist mint slots used).
     */
    ...
    /**
     * @dev Function sets the auxiliary data for `owner`. (e.g. number of whitelist mint slots used).
     * If there are multiple variables, please pack them into a uint64.
     * @param owner Address of Owner
     * @param aux value for aux when casting assembly
     */
     ...
     * @param interfaceId Id of the interface for IERC165, ERC721, ERC721Metadata
     * @return True equals support for interface
     */
    ...
    /**
     * @dev Function to return token name
     * @return Returns the token collection name.
     */
    ...
    /**
     * @dev Function to return token symbol
    ...
    /**
     * @dev Function to returns the Uniform Resource Identifier (URI) for `tokenId` token.
     * @param tokenId ID of the token to return URI of
     * @return URI to token Id
     */
    ...
    /**
     * @dev Internal function to setBaseURI for the contract
     * @notice Set in contructor but can be called later to update URI if needed
     * @param _baseUri URI for contract
     */
     ...
     * @return address of owner of tokenId
     */
     ...
     * @notice function called by ownerOf() to unpack data
     * @param tokenId ID of token
     * @return unpackedOwnership of tokenId
     */
     ...
     * @param index position of data in storage
     * @return unpackedOwnership at index
     */
     ...
     * @param index index of data in storage
     */
     ...
     * @param tokenId ID of token
     * @return packed value for packed data storage
     */
     ...
     * @param packed value for packed data to unpack
     * @return ownership address, startTimestamp, burned and extraData for tokenId
     */
     ...
     * @return result ownership data in uint256
     */
     ...
     * @param quantity quantity of flag
     * @return result TODO
     */
     ...
     * - `tokenId` must exist.
     * @param tokenId ID of token
     * @return _tokenApprovals address approved for tokenId
     */
     ...
     * @param operator Address for operator
     * @param approved Boolean for approval (true equals approved)
     */
     ...
     * @param owner Address of owner
     * @param operator Address for operator
     * @return approval for operator address from owner address boolean
     */
     ...
     * @param owner Address of owner
     * @param msgSender Address of message sender
     * @return result equals true if msgSender equals owner or msgSender equals approvedAddress
     */
     ...
     * @param tokenId ID of token
     * @return approvedAddressSlot storage of approvedAddress memory
     * @return approvedAddress Approved Address
     */
     ...
     * @param from Address of sender
     * @param to Address of recipient
     * @param startTokenId ID of token
     * @param quantity Number of tokens to transfer (used in batch minting)
     */
    function _beforeTokenTransfers(address from, address to, uint256 startTokenId, uint256 quantity) internal virtual {
        require(handler.checkAllRules(from == address(0) ? 0 : balanceOf(from), to == address(0) ? 0 : balanceOf(to), from, to, 1, 0, ActionTypes.TRADE));
     ...
     * @param to Address of recipient
     * @param tokenId ID of token
     * @param approvalCheck approval boolean
     */
     ...
     * Emits a {Transfer} event.
     * @param tokenId ID of token
     * @param approvalCheck approval given boolean
     */
     ...
     * @param index position of data in storage array
     * @param extraData ownership data at index
     */
     ...
     * @param from Address of sender
     * @param to Address of recipient
     * @param previousExtraData data from previous function calls
     * @return position of extraData in storage
     */
     ...
     * @param from Address of sender
     * @param to Address of recipient
     * @param prevOwnershipPacked data from previous function calls
     * @return position of extraData in storage
     */
