 ...
 */
contract ProtocolAMM is AppAdministratorOnly, IApplicationEvents {
     ...
     * @param _ammHandlerAddress valid address of the amm handler
     */
    constructor(address _token0, address _token1, address _appManagerAddress, address _calculatorAddress, address _ammHandlerAddress) {
        token0 = IERC20(_token0);
        token1 = IERC20(_token1);
        appManagerAddress = _appManagerAddress;
        /// Set the calculator and create the variable for it.
        _setCalculatorAddress(_calculatorAddress);
        handler = IProtocolAMMHandler(_ammHandlerAddress);
        handlerAddress = _ammHandlerAddress;
