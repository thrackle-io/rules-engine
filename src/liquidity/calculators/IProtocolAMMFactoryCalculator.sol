...
import {AMMCalculatorErrors, IZeroAddressError, IInputErrors} from "src/interfaces/IErrors.sol";
...
abstract contract IProtocolAMMFactoryCalculator is AppAdministratorOnly, AMMCalculatorErrors, IZeroAddressError, IInputErrors {
     ...
     * @return _amountOut amount of alternate coming out of the pool
     */
    function simulateSwap(uint256 _reserve0, uint256 _reserve1, uint256 _amount0, uint256 _amount1) external virtual view returns (uint256 _amountOut);
}
